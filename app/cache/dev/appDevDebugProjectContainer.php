...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.doctrine.hash_password_listner' => 'getApp_Doctrine_HashPasswordListnerService',
            'app.gravatar' => 'getApp_GravatarService',
            'app.navmenu' => 'getApp_NavmenuService',
            'app.notify' => 'getApp_NotifyService',
            'app.random_string' => 'getApp_RandomStringService',
            'app.security.login_form_authenticator' => 'getApp_Security_LoginFormAuthenticatorService',
            'app.setting' => 'getApp_SettingService',
            'app.social_share' => 'getApp_SocialShareService',
            'app.sweet_alerts' => 'getApp_SweetAlertsService',
            'app.templating' => 'getApp_TemplatingService',
            'app.user_emails' => 'getApp_UserEmailsService',
            'app.wdoopaginator' => 'getApp_WdoopaginatorService',
            'app.widget' => 'getApp_WidgetService',
            'app.youtubeapi' => 'getApp_YoutubeapiService',
            'app.youtubedownload' => 'getApp_YoutubedownloadService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Templating\WdooCache A Webberdoo\AppBundle\Service\Templating\WdooCache instance
     */
    protected function getApp_CacheService()
    {
        return $this->services['app.cache'] = new \Webberdoo\AppBundle\Service\Templating\WdooCache();
    }

    /**
     * Gets the 'app.doctrine.hash_password_listner' service.
     *
     * This service is autowired.
     *
     * @return \Webberdoo\AppBundle\Doctrine\HashPasswordListner A Webberdoo\AppBundle\Doctrine\HashPasswordListner instance
     */
    protected function getApp_Doctrine_HashPasswordListnerService()
    {
        return $this->services['app.doctrine.hash_password_listner'] = new \Webberdoo\AppBundle\Doctrine\HashPasswordListner($this->get('security.password_encoder'));
    }

    /**
     * Gets the 'app.gravatar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Gravatar A Webberdoo\AppBundle\Service\Gravatar instance
     */
    protected function getApp_GravatarService()
    {
        return $this->services['app.gravatar'] = new \Webberdoo\AppBundle\Service\Gravatar();
    }

    /**
     * Gets the 'app.navmenu' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\NavMenu A Webberdoo\AppBundle\Service\NavMenu instance
     */
    protected function getApp_NavmenuService()
    {
        return $this->services['app.navmenu'] = new \Webberdoo\AppBundle\Service\NavMenu($this, 'FD');
    }

    /**
     * Gets the 'app.notify' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Notify A Webberdoo\AppBundle\Service\Notify instance
     */
    protected function getApp_NotifyService()
    {
        return $this->services['app.notify'] = new \Webberdoo\AppBundle\Service\Notify();
    }

    /**
     * Gets the 'app.random_string' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\RandomString A Webberdoo\AppBundle\Service\RandomString instance
     */
    protected function getApp_RandomStringService()
    {
        return $this->services['app.random_string'] = new \Webberdoo\AppBundle\Service\RandomString();
    }
     ...
     * This service is autowired.
     *
     * @return \Webberdoo\AppBundle\Security\LoginFormAuthenticator A Webberdoo\AppBundle\Security\LoginFormAuthenticator instance
     */
    protected function getApp_Security_LoginFormAuthenticatorService()
    {
        return $this->services['app.security.login_form_authenticator'] = new \Webberdoo\AppBundle\Security\LoginFormAuthenticator($this->get('form.factory'), $this->get('doctrine.orm.default_entity_manager'), $this->get('router'), $this->get('security.password_encoder'));
    }

    /**
     * Gets the 'app.setting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\SiteSetting A Webberdoo\AppBundle\Service\SiteSetting instance
     */
    protected function getApp_SettingService()
    {
        return $this->services['app.setting'] = new \Webberdoo\AppBundle\Service\SiteSetting($this);
    }

    /**
     * Gets the 'app.social_share' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\SocialShare A Webberdoo\AppBundle\Service\SocialShare instance
     */
    protected function getApp_SocialShareService()
    {
        return $this->services['app.social_share'] = new \Webberdoo\AppBundle\Service\SocialShare();
    }

    /**
     * Gets the 'app.sweet_alerts' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\SweetAlerts A Webberdoo\AppBundle\Service\SweetAlerts instance
     */
    protected function getApp_SweetAlertsService()
    {
        return $this->services['app.sweet_alerts'] = new \Webberdoo\AppBundle\Service\SweetAlerts();
    }

    /**
     * Gets the 'app.templating' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Templating\WdooTemplate A Webberdoo\AppBundle\Service\Templating\WdooTemplate instance
     */
    protected function getApp_TemplatingService()
    {
        return $this->services['app.templating'] = new \Webberdoo\AppBundle\Service\Templating\WdooTemplate($this);
    }

    /**
     * Gets the 'app.user_emails' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Emails A Webberdoo\AppBundle\Service\Emails instance
     */
    protected function getApp_UserEmailsService()
    {
        return $this->services['app.user_emails'] = new \Webberdoo\AppBundle\Service\Emails($this);
    }

    /**
     * Gets the 'app.wdoopaginator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Pagination\Paginator A Webberdoo\AppBundle\Service\Pagination\Paginator instance
     */
    protected function getApp_WdoopaginatorService()
    {
        return $this->services['app.wdoopaginator'] = new \Webberdoo\AppBundle\Service\Pagination\Paginator();
    }

    /**
     * Gets the 'app.widget' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\Widgets A Webberdoo\AppBundle\Service\Widgets instance
     */
    protected function getApp_WidgetService()
    {
        return $this->services['app.widget'] = new \Webberdoo\AppBundle\Service\Widgets($this);
    }

    /**
     * Gets the 'app.youtubeapi' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\YouTubeApi A Webberdoo\AppBundle\Service\YouTubeApi instance
     */
    protected function getApp_YoutubeapiService()
    {
        return $this->services['app.youtubeapi'] = new \Webberdoo\AppBundle\Service\YouTubeApi($this);
    }

    /**
     * Gets the 'app.youtubedownload' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Webberdoo\AppBundle\Service\YouTubeDownloadClass A Webberdoo\AppBundle\Service\YouTubeDownloadClass instance
     */
    protected function getApp_YoutubedownloadService()
    {
        return $this->services['app.youtubedownload'] = new \Webberdoo\AppBundle\Service\YouTubeDownloadClass();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('WiT5a9hWV6', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Udp3ZqxtNp', 0, 'b-k9vVPQtM6oBK4R4-rriR', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('app.doctrine.hash_password_listner'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'))), 'Webberdoo\\AppBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AppBundle' => 'Webberdoo\\AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4ce1f3bbcb608dd35543f17e314bbffbcfbc07b79c42d3f44f9bb5f4ce6e9d78');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('cMhMoumgPL', NULL, 'b-k9vVPQtM6oBK4R4-rriR', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[2].'/cache/sessions/dev'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => false, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addGlobal('navmenu_service', $this->get('app.navmenu'));
        $instance->addGlobal('widget_service', $this->get('app.widget'));
        $instance->addGlobal('socialshare_service', $this->get('app.social_share'));
        $instance->addGlobal('setting_service', $this->get('app.setting'));
        $instance->addGlobal('gravaatar_service', $this->get('app.gravatar'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('jkhkjh786jhgjhgjhgjhgjhgjhgjjhkjjk');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LP5-wWPtIq', 0, 'b-k9vVPQtM6oBK4R4-rriR', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.save_path': $value = ($this->targetDirs[2].'/cache/sessions/dev'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AppBundle' => 'Webberdoo\\AppBundle\\AppBundle',
            ...
            'secret' => 'jkhkjh786jhgjhgjhgjhgjhgjhgjjhkjjk',
            ...
            'kernel.secret' => 'jkhkjh786jhgjhgjhgjhgjhgjhgjjhkjjk',
